...
const fetchRealHomeMetrics = async (): Promise<HomeMetrics> => {
  ...
  // Get today's and yesterday's metrics using the actual dates
  ...
  console.log('Today data for', todayStr, ':', todayData);
  console.log('Yesterday data for', yesterdayStr, ':', yesterdayData);
